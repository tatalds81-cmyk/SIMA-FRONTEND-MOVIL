      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            bottom: 60, // Mismo tamaño que en la vista de bienvenida
            child: Container(
              decoration: const BoxDecoration(
                color: Color(0xFF052D4F),
                borderRadius: BorderRadius.only(
                  bottomRight: Radius.circular(180), // Curva idéntica a la web
                ),
              ),
            ),
          ),
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 40), // Reducido para que suba la tarjeta y quede como en tu foto
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomButton(
                              text: 'Iniciar sesion',
                              color: const Color(0xFF39A900), // --sima-green sólido
